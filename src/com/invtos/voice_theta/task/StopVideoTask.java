 ...
 *
 */
package com.invtos.voice_theta.task;

import android.os.AsyncTask;

import com.invtos.voice_theta.network.HttpConnector;
import com.invtos.voice_theta.network.HttpEventListener;

public class StopVideoTask extends AsyncTask<Void, Void, HttpConnector.ShootResult> {
    private Callback mCallback;

    public StopVideoTask(Callback callback) {
    ...
    protected HttpConnector.ShootResult doInBackground(Void... params) {
        ...
        return video.stopVideo(postviewListener);
    }
    ...
    private class CaptureListener implements HttpEventListener {
        ...
        public void onObjectChanged(String latestCapturedFileId) {
            ...
            mCallback.onStopVideo(latestCapturedFileId);
        }
    ...
    public interface Callback {
        void onStopVideo(String fileUrl);
    }
