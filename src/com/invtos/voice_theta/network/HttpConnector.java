...
/* Change to Add setCommandOption  for general setOptions
   By Wichai Tossamartvorakul       21 Jun 2019
 */

package com.invtos.voice_theta.network;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import com.invtos.voice_theta.model.ImageSize;
...
public class HttpConnector {
    ...
    public ShootResult takePicture(HttpEventListener listener) {
        ...
        String errorMessage = setCommandOption("exposureDelay","5");
               errorMessage = setCommandOption("captureMode","image");
    ...
    public InputStream getLivePreview() throws IOException, JSONException {
        ...
        // set capture mode to image
        setCommandOption("captureMode","image");
        //setImageCaptureMode();
...
// Start Add support Video by Wichai on 20 Jun 2019
    ...
    public ShootResult startVideo(HttpEventListener listener) {
        ...
        String errorMessage = setCommandOption("captureMode","video");
